                ...
                <div class="table-scroll">
                    <table class="table table-bordered table-striped mb-0" id="datatable-default">
                        ...
                        <tbody>
                            @forelse ($sheets as $s)
                            @php
                                $bidsCount    = $s->bids_count ?? 0;
                                $wonCount     = $s->won_count ?? 0;
                                $lostCount    = $s->lost_count ?? 0;
                                $pendingCount = max($bidsCount - $wonCount - $lostCount, 0);
                            @endphp
                            <tr>
                                ...
                                <td>{{ $bidsCount }}</td>
                                <td><span class="badge bg-success">{{ $wonCount }}</span></td>
                                <td><span class="badge bg-danger">{{ $lostCount }}</span></td>
                            ...
                            @empty
                                <tr><td colspan="{{ $isPrivileged ? 9 : 8 }}" class="text-center text-muted py-4">No bid sheets uploaded yet.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
