...
@section('content')
@php
    $statusColors = ['invoiced'=>'primary','dispatched'=>'warning text-dark','arrived'=>'warning text-dark','delivered'=>'success'];
            ...
            <table class="table table-bordered table-striped mb-0" id="datatable-default">
                <thead>
                    <tr>
                        ...
                        <th>Won On</th><th>Status</th><th>Invoice</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @empty<tr><td colspan="{{ $isPrivileged ? 6 : 5 }}" class="text-center text-muted py-4">No sold vehicles yet.</td></tr>@endforelse
                </tbody>
            </table>
        </div>
    </div>
