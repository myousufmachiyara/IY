            ...
            <div class="card-body">
                ...
                @if(auth()->user()->isSuperAdmin())
                    <div class="alert alert-info py-2">
                        <i class="fa fa-info-circle"></i> As Super Admin, vehicles below 50% paid are also shown below and can be included.
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('shipments.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <small class="text-muted">Final 50% due date is calculated from this (arrival − 22 days).</small>
                        </div>
                        <div class="col-md-4 mb-2">
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="{{ $v->invoice->isHalfPaid() ? '' : 'text-danger' }}">{{ $v->invoice->paidPercent() }}%</td>
